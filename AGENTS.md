...
- Web-visible runs must write `gallery_manifest.json` last via `write_gallery_manifest`; list every transitive artifact and keep all web-consumed paths repository-relative.
